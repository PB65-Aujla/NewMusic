...
from VIPMUSIC.plugins.tools.pretenderdb import (
    impo_off,
    impo_on,
    check_pretender,
    add_userdata,
...
""".format(
    ...
    if msg != "":
        await message.reply_photo(
            "https://graph.org/file/f8c1ab5f055c4d89ecfbd.jpg", caption=msg
        )
...
async def set_mataa(_, message: Message):
    if len(message.command) == 1:
        return await message.reply(
            "**ᴅᴇᴛᴇᴄᴛ sᴘɪᴄᴀʟᴡʟᴄ ᴜsᴇʀs ᴜsᴀɢᴇ : sᴘɪᴄᴀʟ ᴇɴᴀʙʟᴇ|ᴅɪsᴀʙʟᴇ**"
        )
