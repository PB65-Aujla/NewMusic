...
from VIPMUSIC.plugins.tools.pretenderdb import impo_off, impo_on, check_pretender, add_userdata, get_userdata, usr_data
...
""".format(
    ...
    if msg != "":
        await message.reply_photo("https://graph.org/file/f8c1ab5f055c4d89ecfbd.jpg", caption=msg)
